...
class Wallet():
    def __init__(self):
        self.transactions = {}
        # Create the accountList to store all the accounts in ganache.  

        # Access all the accounts of ganache in the ganacheAccounts. 

        # Use for loop to store all the accounts in the accountList.
